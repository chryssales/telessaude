...
/**
 * Strings for component 'moodle', language 'pt_br', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['activitymodules'] = 'Módulos de atividades';
...
$string['addblock'] = 'Acrescentar um bloco';
$string['addcomment'] = 'Adicionar um comentário...';
$string['addcountertousername'] = 'Criar usuário adicionando número para o nome de usuário';
...
$string['addedtogroupnotenrolled'] = 'Não acrescentado ao grupo "{$a}" por que não está inscrito no curso';
...
$string['availability_help'] = 'Esta configuração determina se o curso aparece na lista de cursos. Além de professores e administradores, os demais usuários não têm permissão para entrar no curso.';
...
$string['blockdeleteconfirm'] = 'Você está prestes a excluir completamente o bloco \'{$a}\'. Todas as informações e dados associados a este bloco serão excluídos da base de dados. Você tem CERTEZA de que deseja continuar?';
...
$string['coursehelpnewsitemsnumber'] = 'Número de itens recentes que aparecerão na página inicial do curso, em uma caixa de notícias no lado direito (0 faz com que a caixa de notícias não apareça).';
...
$string['enterusername'] = 'Insira seu usuário';
...
$string['expirynotifyemail'] = 'Os seguintes alunos deste curso têm a data de expiração de inscrição em {$a->threshold} dias:
...
$string['forcedmodeinbrackets'] = '{$a} (modo forçado)';
...
$string['hidetopicfromothers'] = 'Esconder tópico';
$string['hideweekfromothers'] = 'Esconder semana';
$string['hits'] = 'Hits';
...
$string['invalidusername'] = 'O usuário pode conter somente caracteres alfanuméricos minúsculos, underline (_), hífen (-), ponto (.) ou arroba (@)';
$string['invalidusernameupload'] = 'Usuário inválido';
...
$string['local'] = 'Local';
$string['localplugindeleteconfirm'] = 'Você está prestes a excluir completamente o plugin local \'{$a}\'. Isto irá excluir tudo associado a este plugin no banco de dados. Você tem CERTEZA que quer continuar?';
...
$string['loginusing'] = 'Acesse aqui, usando seu usuário e senha';
$string['logout'] = 'Sair';
...
$string['missingusername'] = 'Está faltando o  usuário';
...
$string['mymoodledashboard'] = 'Meu painel do Moodle';
...
Uma nova conta foi criada para você em  \'{$a->sitename}\' e recebeu uma senha provisória.
...
$string['order'] = 'Ordem';
$string['orphanedactivities'] = 'Atividades órfãs';
$string['other'] = 'Outro';
...
$string['pageshouldredirect'] = 'Esta página será automaticamente redirecionada. Se nada estiver acontecendo, por favor use o link continuar, abaixo.';
...
$string['screenreaderuse_help'] = 'Se definido como sim, uma interface mais acessível é fornecida em diversos lugares, como no chat.';
...
$string['showtopicfromothers'] = 'Exibir tópico';
$string['showweekfromothers'] = 'Exibir semana';
$string['since'] = 'Desde';
...
$string['statsreport2'] = 'Visualizações (todas as funções)';
$string['statsreport3'] = 'Posts (todas as funções)';
$string['statsreport4'] = 'Toda atividade (todas as funções)';
...
$string['statsreportactivity'] = 'Toda atividade (todas as funções)';
...
$string['statsreportreads'] = 'Visualizações (todas as funções)';
$string['statsreporttype'] = 'Tipo de relatório';
$string['statsreportwrites'] = 'Posts (todas as funções)';
...
$string['updatemymoodleoff'] = 'Parar de editar esta página';
...
$string['usernameemailmatch'] = 'O usuário e o email não correspondem ao mesmo usuário';
$string['usernameexists'] = 'Este usuário já existe. Escolha outro.';
$string['usernamelowercase'] = 'Apenas letras minúsculas';
$string['usernamenotfound'] = 'O usuário não foi encontrado na base de dados';
$string['usernameoremail'] = 'Inserira o usuário ou endereço email';
...
$string['userselectorpreserveselected'] = 'Manter os usuários selecionados, mesmo se a busca não retornar nenhum resultado.';
$string['userselectorsearchanywhere'] = 'Encontrar o texto da busca em qualquer parte do nome do usuário';
