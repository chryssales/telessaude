...
$string['completion-alt-auto-fail'] = 'Concluído (não obteve nota para aprovação)';
$string['completion-alt-auto-n'] = 'Não concluído(s): {$a}';
$string['completion-alt-auto-pass'] = 'Concluído (foi atingida a nota de aprovação)';
$string['completion-alt-auto-y'] = 'Concluído: {$a}';
$string['completion-alt-manual-enabled'] = 'Os cursistas podem marcar manualmente este item como concluído';
