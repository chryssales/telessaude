...
/**
 * Strings for component 'quiz', language 'pt_br', branch 'MOODLE_22_STABLE'
 *
 * @package   quiz
...
$string['addnewgroupoverride'] = 'Adicionar grupo anulado';
...
$string['addnewuseroverride'] = 'Adicionar usuário anulado';
...
$string['addrandomquestion'] = 'Adicionar perguntas aleatórias';
...
$string['editoverride'] = 'Editar anulação';
...
$string['emailnotifysmall'] = '{$a->studentname} completou {$a->quizname}';
...
$string['groupoverrides'] = 'Anular grupo';
...
$string['invalidoverrideid'] = 'Identificação inválida de anulação';
...
$string['name'] = 'Nome';
$string['navnojswarning'] = '<b>Atenção</b>: esses <em>links</em> não vão salvar as suas respostas. Use o botão \'Avançar\' na parte inferior da página.';
...
$string['nooverridedata'] = 'Você precisa naular ao menos uma configuração de questionário.';
...
$string['overridedeleteusersure'] = 'Você tem certeza que deseja apagar a anulação de usuário {$a}?';
$string['overridegroup'] = 'Anular grupo';
$string['overridegroupeventname'] = '{$a->quiz} - {$a->group}';
$string['overrides'] = 'Anular';
$string['overrideuser'] = 'Anular usuário';
...
$string['saveoverrideandstay'] = 'Salvar e entrar com outra anulação';
...
$string['startnewpreview'] = 'Inciar nova visualização';
...
$string['top'] = 'Topo';
$string['totalpointsx'] = 'Total de avaliações: {$a}';
...
$string['useroverrides'] = 'Anular usuário';
