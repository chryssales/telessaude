...
$string['siteemail_help'] = 'Você deve informar um endereço de email para que o administrador possa entrar em contato caso seja necessário. Este email não será utilizado para nenhum outro propósito.';
